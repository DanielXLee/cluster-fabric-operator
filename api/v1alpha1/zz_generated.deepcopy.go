...
func (in *AWS) DeepCopyInto(out *AWS) {
	*out = *in
	out.CommonPrepareConfig = in.CommonPrepareConfig
}
...
func (in *BrokerConfig) DeepCopyInto(out *BrokerConfig) {
	*out = *in
	if in.ComponentArr != nil {
		in, out := &in.ComponentArr, &out.ComponentArr
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.GlobalCIDRConfigMap != nil {
		in, out := &in.GlobalCIDRConfigMap, &out.GlobalCIDRConfigMap
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonPrepareConfig) DeepCopyInto(out *CommonPrepareConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonPrepareConfig.
func (in *CommonPrepareConfig) DeepCopy() *CommonPrepareConfig {
	if in == nil {
		return nil
	}
	out := new(CommonPrepareConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FabricSpec) DeepCopyInto(out *FabricSpec) {
	*out = *in
	...
	out.CloudPrepareConfig = in.CloudPrepareConfig
}
